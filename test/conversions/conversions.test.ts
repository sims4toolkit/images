/*
  This file takes the images that exist in the "images" directory, converts them
  to unshuffled DDS images (DXT compression), and outputs them to the "out"
  directory. It should be verified that the DDS images that are produced are
  valid images around 22KB, and are able to be rendered.
